...
/** Details for a selected exchange rate row. */
...
export type NbpSelection = RateSelection | GoldSelection;
...
export function NbpDetails({ selection, onClose, onNavigateToChart }: NbpDetailsProps): React.JSX.Element | null {
  ...
  return (
    <motion.aside
      key={selection.type === 'rate' ? selection.rate.code : selection.goldPrice.data}
